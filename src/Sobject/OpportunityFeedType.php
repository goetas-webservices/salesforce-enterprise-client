...
/**
 * Class representing OpportunityFeedType
 *
 *
 * XSD Type: OpportunityFeed
 */
class OpportunityFeedType extends SObjectType
{
    ...
    /**
     * @property \GoetasWebservices\Client\SalesforceEnterprise\Sobject\OpportunityType $parent
     */
    private $parent = null;
     ...
     * Sets a new parent
     *
     * @param \GoetasWebservices\Client\SalesforceEnterprise\Sobject\OpportunityType $parent
     * @return self
     */
    public function setParent(\GoetasWebservices\Client\SalesforceEnterprise\Sobject\OpportunityType $parent)
    {
        $this->parent = $parent;
        return $this;
    }
