...
/**
 * Class representing PartnerRoleType
 *
 *
 * XSD Type: PartnerRole
 */
class PartnerRoleType extends SObjectType
{
     ...
     * @return string
     */
    public function getReverseRole()
    {
        return $this->reverseRole;
    }

    /**
     * Sets a new reverseRole
     *
     * @param string $reverseRole
     * @return self
     */
    public function setReverseRole($reverseRole)
    {
