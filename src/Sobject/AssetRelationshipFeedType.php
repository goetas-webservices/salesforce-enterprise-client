...
/**
 * Class representing AssetRelationshipFeedType
 *
 *
 * XSD Type: AssetRelationshipFeed
 */
class AssetRelationshipFeedType extends SObjectType
{
    ...
    /**
     * @property \GoetasWebservices\Client\SalesforceEnterprise\Sobject\AssetRelationshipType $parent
     */
    private $parent = null;
     ...
     * Sets a new parent
     *
     * @param \GoetasWebservices\Client\SalesforceEnterprise\Sobject\AssetRelationshipType $parent
     * @return self
     */
    public function setParent(\GoetasWebservices\Client\SalesforceEnterprise\Sobject\AssetRelationshipType $parent)
    {
        $this->parent = $parent;
        return $this;
    }
