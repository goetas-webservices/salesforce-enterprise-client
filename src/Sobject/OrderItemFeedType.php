...
/**
 * Class representing OrderItemFeedType
 *
 *
 * XSD Type: OrderItemFeed
 */
class OrderItemFeedType extends SObjectType
{
    ...
    /**
     * @property \GoetasWebservices\Client\SalesforceEnterprise\Sobject\OrderItemType $parent
     */
    private $parent = null;
     ...
     * Sets a new parent
     *
     * @param \GoetasWebservices\Client\SalesforceEnterprise\Sobject\OrderItemType $parent
     * @return self
     */
    public function setParent(\GoetasWebservices\Client\SalesforceEnterprise\Sobject\OrderItemType $parent)
    {
        $this->parent = $parent;
        return $this;
    }
