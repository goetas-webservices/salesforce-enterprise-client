...
/**
 * Class representing UserFeedType
 *
 *
 * XSD Type: UserFeed
 */
class UserFeedType extends SObjectType
{
    ...
    /**
     * @property \GoetasWebservices\Client\SalesforceEnterprise\Sobject\UserType $parent
     */
    private $parent = null;
     ...
     * Sets a new parent
     *
     * @param \GoetasWebservices\Client\SalesforceEnterprise\Sobject\UserType $parent
     * @return self
     */
    public function setParent(\GoetasWebservices\Client\SalesforceEnterprise\Sobject\UserType $parent)
    {
        $this->parent = $parent;
        return $this;
    }
