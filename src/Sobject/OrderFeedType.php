...
/**
 * Class representing OrderFeedType
 *
 *
 * XSD Type: OrderFeed
 */
class OrderFeedType extends SObjectType
{
    ...
    /**
     * @property \GoetasWebservices\Client\SalesforceEnterprise\Sobject\OrderType $parent
     */
    private $parent = null;
     ...
     * Sets a new parent
     *
     * @param \GoetasWebservices\Client\SalesforceEnterprise\Sobject\OrderType $parent
     * @return self
     */
    public function setParent(\GoetasWebservices\Client\SalesforceEnterprise\Sobject\OrderType $parent)
    {
        $this->parent = $parent;
        return $this;
    }
