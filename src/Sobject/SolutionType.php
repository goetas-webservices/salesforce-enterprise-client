 ...
 * XSD Type: Solution
 */
class SolutionType extends SObjectType
{
     ...
     */
    private $isPublishedInPublicKb = null;
     ...
     */
    private $solutionName = null;

    /**
     * @property string $solutionNote
     */
    private $solutionNote = null;

    /**
     * @property string $solutionNumber
     */
    private $solutionNumber = null;
    ...
    /**
     * Sets a new isPublishedInPublicKb
     *
     * @param bool $isPublishedInPublicKb
     * @return self
     */
    public function setIsPublishedInPublicKb($isPublishedInPublicKb)
    {
