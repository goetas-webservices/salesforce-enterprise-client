...
/**
 * Class representing SearchActivityType
 *
 *
 * XSD Type: SearchActivity
 */
class SearchActivityType extends SObjectType
{
    ...
    /**
     * @property string $clickedRecordName
     */
    private $clickedRecordName = null;
    ...
    /**
     * @property string $kbChannel
     */
    private $kbChannel = null;
    ...
    /**
     * Gets as clickedRecordName
     *
     * @return string
     */
    public function getClickedRecordName()
    {
        return $this->clickedRecordName;
    }

    /**
     * Sets a new clickedRecordName
     *
     * @param string $clickedRecordName
     * @return self
     */
    public function setClickedRecordName($clickedRecordName)
    {
     ...
     * @return string
     */
    public function getKbChannel()
    {
        return $this->kbChannel;
    }

    /**
     * Sets a new kbChannel
     *
     * @param string $kbChannel
     * @return self
     */
    public function setKbChannel($kbChannel)
    {
