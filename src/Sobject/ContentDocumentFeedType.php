...
/**
 * Class representing ContentDocumentFeedType
 *
 *
 * XSD Type: ContentDocumentFeed
 */
class ContentDocumentFeedType extends SObjectType
{
    ...
    /**
     * @property \GoetasWebservices\Client\SalesforceEnterprise\Sobject\ContentDocumentType $parent
     */
    private $parent = null;
     ...
     * Sets a new parent
     *
     * @param \GoetasWebservices\Client\SalesforceEnterprise\Sobject\ContentDocumentType $parent
     * @return self
     */
    public function setParent(\GoetasWebservices\Client\SalesforceEnterprise\Sobject\ContentDocumentType $parent)
    {
        $this->parent = $parent;
        return $this;
    }
