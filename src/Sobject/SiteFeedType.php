...
/**
 * Class representing SiteFeedType
 *
 *
 * XSD Type: SiteFeed
 */
class SiteFeedType extends SObjectType
{
    ...
    /**
     * @property \GoetasWebservices\Client\SalesforceEnterprise\Sobject\SiteType $parent
     */
    private $parent = null;
     ...
     * Sets a new parent
     *
     * @param \GoetasWebservices\Client\SalesforceEnterprise\Sobject\SiteType $parent
     * @return self
     */
    public function setParent(\GoetasWebservices\Client\SalesforceEnterprise\Sobject\SiteType $parent)
    {
        $this->parent = $parent;
        return $this;
    }
