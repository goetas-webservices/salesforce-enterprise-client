...
/**
 * Class representing DandBCompanyType
 *
 *
 * XSD Type: DandBCompany
 */
class DandBCompanyType extends SObjectType
{

    /**
     * @property \GoetasWebservices\Client\SalesforceEnterprise\Types\QueryResultType $accounts
     */
     ...
     */
    private $geocodeAccuracyStandard = null;
     ...
     * Sets a new accounts
     *
     * @param \GoetasWebservices\Client\SalesforceEnterprise\Types\QueryResultType $accounts
     * @return self
     */
    public function setAccounts(\GoetasWebservices\Client\SalesforceEnterprise\Types\QueryResultType $accounts)
    {
    ...
    /**
     * Gets as geocodeAccuracyStandard
     *
     * @return string
     */
    public function getGeocodeAccuracyStandard()
    {
        return $this->geocodeAccuracyStandard;
    }

    /**
     * Sets a new geocodeAccuracyStandard
     *
     * @param string $geocodeAccuracyStandard
     * @return self
     */
    public function setGeocodeAccuracyStandard($geocodeAccuracyStandard)
    {
