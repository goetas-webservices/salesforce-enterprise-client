...
/**
 * Class representing LightningUsageByBrowserMetricsType
 *
 *
 * XSD Type: LightningUsageByBrowserMetrics
 */
class LightningUsageByBrowserMetricsType extends SObjectType
{
