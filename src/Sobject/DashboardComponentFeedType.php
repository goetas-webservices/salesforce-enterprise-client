...
/**
 * Class representing DashboardComponentFeedType
 *
 *
 * XSD Type: DashboardComponentFeed
 */
class DashboardComponentFeedType extends SObjectType
{
    ...
    /**
     * @property \GoetasWebservices\Client\SalesforceEnterprise\Sobject\DashboardComponentType $parent
     */
    private $parent = null;
     ...
     * Gets as parent
     *
     * @return \GoetasWebservices\Client\SalesforceEnterprise\Sobject\DashboardComponentType
     */
     ...
     * Sets a new parent
     *
     * @param \GoetasWebservices\Client\SalesforceEnterprise\Sobject\DashboardComponentType $parent
     * @return self
     */
    public function setParent(\GoetasWebservices\Client\SalesforceEnterprise\Sobject\DashboardComponentType $parent)
    {
        $this->parent = $parent;
        return $this;
    }
