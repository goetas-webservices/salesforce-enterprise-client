...
/**
 * Class representing InstalledMobileAppType
 *
 *
 * XSD Type: InstalledMobileApp
 */
class InstalledMobileAppType extends SObjectType
{

    /**
     * @property \GoetasWebservices\Client\SalesforceEnterprise\Sobject\ConnectedApplicationType $connectedApplication
     */
    private $connectedApplication = null;

    /**
     * @property string $connectedApplicationId
     */
    private $connectedApplicationId = null;
    ...
    /**
     * Sets a new connectedApplication
     *
     * @param \GoetasWebservices\Client\SalesforceEnterprise\Sobject\ConnectedApplicationType $connectedApplication
     * @return self
     */
    public function setConnectedApplication(\GoetasWebservices\Client\SalesforceEnterprise\Sobject\ConnectedApplicationType $connectedApplication)
    {
    ...
    /**
     * Gets as connectedApplicationId
     *
     * @return string
     */
    public function getConnectedApplicationId()
    {
        return $this->connectedApplicationId;
    }

    /**
     * Sets a new connectedApplicationId
     *
     * @param string $connectedApplicationId
     * @return self
     */
    public function setConnectedApplicationId($connectedApplicationId)
    {
