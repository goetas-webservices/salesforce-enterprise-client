...
/**
 * Class representing ContactFeedType
 *
 *
 * XSD Type: ContactFeed
 */
class ContactFeedType extends SObjectType
{
    ...
    /**
     * @property \GoetasWebservices\Client\SalesforceEnterprise\Sobject\ContactType $parent
     */
    private $parent = null;
     ...
     * Sets a new parent
     *
     * @param \GoetasWebservices\Client\SalesforceEnterprise\Sobject\ContactType $parent
     * @return self
     */
    public function setParent(\GoetasWebservices\Client\SalesforceEnterprise\Sobject\ContactType $parent)
    {
        $this->parent = $parent;
        return $this;
    }
