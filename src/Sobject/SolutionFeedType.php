...
/**
 * Class representing SolutionFeedType
 *
 *
 * XSD Type: SolutionFeed
 */
class SolutionFeedType extends SObjectType
{
    ...
    /**
     * @property \GoetasWebservices\Client\SalesforceEnterprise\Sobject\SolutionType $parent
     */
    private $parent = null;
     ...
     * Sets a new parent
     *
     * @param \GoetasWebservices\Client\SalesforceEnterprise\Sobject\SolutionType $parent
     * @return self
     */
    public function setParent(\GoetasWebservices\Client\SalesforceEnterprise\Sobject\SolutionType $parent)
    {
        $this->parent = $parent;
        return $this;
    }
