...
/**
 * Class representing EventFeedType
 *
 *
 * XSD Type: EventFeed
 */
class EventFeedType extends SObjectType
{
    ...
    /**
     * @property \GoetasWebservices\Client\SalesforceEnterprise\Sobject\EventType $parent
     */
    private $parent = null;
     ...
     * Sets a new parent
     *
     * @param \GoetasWebservices\Client\SalesforceEnterprise\Sobject\EventType $parent
     * @return self
     */
    public function setParent(\GoetasWebservices\Client\SalesforceEnterprise\Sobject\EventType $parent)
    {
        $this->parent = $parent;
        return $this;
    }
