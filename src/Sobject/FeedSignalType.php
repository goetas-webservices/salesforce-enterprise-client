...
/**
 * Class representing FeedSignalType
 *
 *
 * XSD Type: FeedSignal
 */
class FeedSignalType extends SObjectType
{
     ...
     */
    private $signalType = null;

    /**
     * @property int $signalValue
     */
    private $signalValue = null;
    ...
    /**
     * Sets a new signalValue
     *
     * @param int $signalValue
     * @return self
     */
    public function setSignalValue($signalValue)
    {
