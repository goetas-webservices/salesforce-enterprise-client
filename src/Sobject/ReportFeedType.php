...
/**
 * Class representing ReportFeedType
 *
 *
 * XSD Type: ReportFeed
 */
class ReportFeedType extends SObjectType
{
    ...
    /**
     * @property \GoetasWebservices\Client\SalesforceEnterprise\Sobject\ReportType $parent
     */
    private $parent = null;
     ...
     * Gets as parent
     *
     * @return \GoetasWebservices\Client\SalesforceEnterprise\Sobject\ReportType
     */
     ...
     * Sets a new parent
     *
     * @param \GoetasWebservices\Client\SalesforceEnterprise\Sobject\ReportType $parent
     * @return self
     */
    public function setParent(\GoetasWebservices\Client\SalesforceEnterprise\Sobject\ReportType $parent)
    {
        $this->parent = $parent;
        return $this;
    }
