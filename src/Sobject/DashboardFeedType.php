...
/**
 * Class representing DashboardFeedType
 *
 *
 * XSD Type: DashboardFeed
 */
class DashboardFeedType extends SObjectType
{
    ...
    /**
     * @property \GoetasWebservices\Client\SalesforceEnterprise\Sobject\DashboardType $parent
     */
    private $parent = null;
     ...
     * Gets as parent
     *
     * @return \GoetasWebservices\Client\SalesforceEnterprise\Sobject\DashboardType
     */
     ...
     * Sets a new parent
     *
     * @param \GoetasWebservices\Client\SalesforceEnterprise\Sobject\DashboardType $parent
     * @return self
     */
    public function setParent(\GoetasWebservices\Client\SalesforceEnterprise\Sobject\DashboardType $parent)
    {
        $this->parent = $parent;
        return $this;
    }
